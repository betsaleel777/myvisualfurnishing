    ...
    <main class="cs-page-wrapper">
                ...
                <div class="modal-content border-0">
                    <div class="cs-view show" id="modal-signin-view">
                        ...
                        <div class="modal-body px-4">
                            <p class="font-size-ms text-muted">Connectez vous et consulter les informations de votre
                                profil</p>
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="input-group-overlay cs-password-toggle form-group">
                                    ...
                                    <label class="cs-password-toggle-btn">
                                        <input class="custom-control-input" type="checkbox"><i
                                            class="fe-eye cs-password-toggle-indicator"></i><span class="sr-only">Voir
                                            mot de passe</span>
                                    </label>
                                </div>
                                <div class="d-flex justify-content-between align-items-center form-group">
                                    ...
                                    </div><a class="nav-link-style font-size-ms" href="password-recovery.html">Mot de
                                        passe oublié</a>
                                </div>
                                <button class="btn btn-primary btn-block" type="submit">Se connecter</button>
                                <p class="font-size-sm pt-3 mb-0">Je n'ai pas de compte? <a href='#'
                                        class='font-weight-medium' data-view='#modal-signup-view'>S'incrire</a></p>
                            </form>
                        </div>
                    </div>
                    <div class="cs-view" id="modal-signup-view">
                        ...
                        <div class="modal-body px-4">
                            <p class="font-size-ms text-muted">Inscrivez vous et accéder à d'avantages de
                                fonctionnalités.</p>
                            <form class="needs-validation" novalidate>
                                ...
                                <p class="font-size-sm pt-3 mb-0">J'ai déjà un compte ? <a href='#'
                                        class='font-weight-medium' data-view='#modal-signin-view'>Se connecter</a></p>
                            </form>
                        </div>
                    </div>
                    <div class="modal-body text-center px-4 pt-2 pb-4">
                        <hr>
                        <p class="font-size-sm font-weight-medium text-heading pt-4">ou connectez vous avec</p><a
        ...
        <div class="cs-offcanvas cs-offcanvas-collapse-always cs-offcanvas-right" id="shoppingCart">
            ...
            <div class="cs-offcanvas-body p-4" data-simplebar>
                <div class="media align-items-center mb-3"><a class="d-block" href="{{ route('shop-single') }}"><img
                            class="rounded" width="60"
                            src="{{ asset('dist/img/demo/shop-homepage/thumbnails/05.jpg') }}" alt="Product" /></a>
                    <div class="media-body pl-2 ml-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="mr-3">
                                <h4 class="nav-heading font-size-md mb-1"><a class="font-weight-medium"
                                        href="{{ route('shop-single') }}">Smart Watch Series 5</a></h4>
                                <div class="d-flex align-items-center font-size-sm"><span
                                        class="mr-2">$364.99</span><span class="mr-2">x</span>
                                    <input class="form-control form-control-sm px-2" type="number"
                                        style="max-width: 3.5rem;" value="1">
                                </div>
                            </div>
                            <div class="pl-3 border-left"><a
                                    class="d-block text-danger text-decoration-none font-size-xl" href="#"
                                    data-toggle="tooltip" title="Remove"><i class="fe-x-circle"></i></a></div>
                        </div>
                    </div>
                </div>
                <div class="media align-items-center mb-3"><a class="d-block" href="{{ route('shop-single') }}"><img
                    ...
                    <div class="media-body pl-2 ml-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="mr-3">
                                <h4 class="nav-heading font-size-md mb-1"><a class="font-weight-medium"
                                        href="{{ route('shop-single') }}">Running Sneakers, Collection</a></h4>
                                <div class="d-flex align-items-center font-size-sm"><span
                                        class="mr-2">$145.00</span><span class="mr-2">x</span>
                                    <input class="form-control form-control-sm px-2" type="number"
                                        style="max-width: 3.5rem;" value="1">
                                </div>
                            </div>
                ...
                <div class="media align-items-center mb-3"><a class="d-block" href="{{ route('shop-single') }}"><img
                    ...
                    <div class="media-body pl-2 ml-1">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="mr-3">
                                <h4 class="nav-heading font-size-md mb-1"><a class="font-weight-medium"
                                        href="{{ route('shop-single') }}">Wireless Bluetooth Headset</a></h4>
                                <div class="d-flex align-items-center font-size-sm"><span
                                        class="mr-2">$258.00</span><span class="mr-2">x</span>
                                    <input class="form-control form-control-sm px-2" type="number"
                                        style="max-width: 3.5rem;" value="1">
                                </div>
                            </div>
            ...
            <div class="cs-offcanvas-cap d-block border-top px-4 mb-2">
                ...
                </div><a class="btn btn-primary btn-sm btn-block" href="checkout.html"><i
                        class="fe-credit-card font-size-base mr-2"></i>procéder à une commande</a>
            </div>
        </div>
            ...
            <div class="topbar topbar-dark bg-dark">
                <div class="container d-md-flex align-items-center px-0 px-xl-3">
                    <div class="d-none d-md-block text-nowrap mr-3"><i
                            class="fe-phone font-size-base text-muted mr-1"></i><span
                            class="text-muted mr-2">Aide</span><a class="topbar-link mr-1"
                            href="tel:9107848015">910-784-8015</a></div>
                    <div class="d-flex text-md-right ml-md-auto"><a class="topbar-link pr-2 mr-4"
                            href="order-tracking.html"><i
                                class="fe-map-pin font-size-base opacity-60 mr-1"></i>Suivre<span
                                class='d-none d-sm-inline'> commandes</span></a>
                        {{-- <div class="dropdown ml-auto ml-md-0 mr-3"><a
                                class="topbar-link dropdown-toggle" href="#" data-toggle="dropdown"><img class="mr-2"
                                    width="20" src="img/flags/en.png"
                                    alt="English" />Eng</a>--}}
                            {{-- <div class="dropdown-menu dropdown-menu-right"><a
                                    class="dropdown-item" href="#"><img class="mr-2" width="20" src="img/flags/fr.png"
                                        alt="Français" />Français</a><a class="dropdown-item" href="#"><img class="mr-2"
                                        width="20" src="img/flags/de.png" alt="Deutsch" />Deutsch</a><a
                                    class="dropdown-item" href="#"><img class="mt-n1 mr-2" width="20"
                                        src="img/flags/it.png" alt="Italiano" />Italiano</a></div>
                            --}}
                            {{-- </div>--}}
                        {{-- <div class="dropdown"><a class="topbar-link dropdown-toggle"
                                href="#" data-toggle="dropdown">$ Dollar (US)</a>--}}
                            {{-- <div class="dropdown-menu dropdown-menu-right"><a
                                    class="dropdown-item" href="#">€ Euro (EU)</a><a class="dropdown-item" href="#">£
                                    Pound (UK)</a><a class="dropdown-item" href="#">¥ Yen (JP)</a></div>
                            --}}
                            {{-- </div>--}}
                    </div>
                </div>
                ...
                <div class="container px-0 px-xl-3">
                    <button class="navbar-toggler ml-n2 mr-4" type="button" data-toggle="offcanvas"
                        ...
                        class="navbar-brand order-lg-1 mx-auto ml-lg-0 pr-lg-2 mr-lg-4" href="index.html"><img
                            class="d-none d-lg-block" width="153" src="{{ asset('dist/img/logo/logo-dark.png') }}"
                            alt="vfurnishing" /><img class="d-lg-none" width="58"
                            src="{{ asset('dist/img/logo/logo-icon.png') }}" alt="vfurnishing" /></a>
                    <div class="d-flex align-items-center order-lg-3 ml-lg-auto">
                        <div class="navbar-tool"><a class="navbar-tool-icon-box mr-2" href="#" data-toggle="search"><i
                                    class="fe-search"></i></a></div>
                        <div class="navbar-tool d-none d-sm-flex"><a class="navbar-tool-icon-box mr-2"
                                href="#modal-signin" data-toggle="modal" data-view="#modal-signin-view"><i
                                    class="fe-user"></i></a></div>
                        ...
                        <div class="navbar-tool mr-2"><a class="navbar-tool-icon-box" href="#" data-toggle="offcanvas"
                                data-offcanvas-id="shoppingCart"><i class="fe-shopping-cart"></i><span
                                    class="navbar-tool-badge">3</span></a></div>
                    </div>
