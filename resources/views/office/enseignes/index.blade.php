                        ...
                        @empty($enseignes->all())
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    ...
                                    <td>{{$enseigne->site}}</td>
                                    <td class="text-right">
                                        <a class="btn btn-outline-primary" href="{{route('enseigne_edit',$enseigne)}}">modifier</a>
                                        <a class="btn btn-outline-warning" href="{{route('enseigne_show',$enseigne)}}">détails</a>
                                        <a class="btn btn-outline-danger" href="{{route('enseigne_delete',$enseigne)}}">supprimer</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
