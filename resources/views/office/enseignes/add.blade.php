                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('nom') }}" id="nom" name="nom"
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('contact') }}" id="contact" name="contact"
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('site') }}" id="site" name="site"
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('siege') }}" id="siege" name="siege"
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('nom_magasin') }}" id="nom_magasin" name="nom_magasin"
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('lieu') }}" id="lieu" name="lieu"
