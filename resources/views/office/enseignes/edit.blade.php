                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$enseigne->nom}}" id="nom" name="nom" class="form-control @error('nom') is-invalid @enderror" type="text">
                                @error('nom')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$enseigne->contact}}" id="contact" name="contact" class="form-control @error('contact') is-invalid @enderror" type="text">
                                @error('contact')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$enseigne->site}}" id="site" name="site" class="form-control @error('site') is-invalid @enderror" type="text">
                                @error('site')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$enseigne->email}}" id="email" name="email" class="form-control @error('email') is-invalid @enderror" type="text">
                                @error('email')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input value="{{$enseigne->siege}}" id="siege" name="siege" class="form-control @error('siege') is-invalid @enderror" type="text">
                                @error('siege')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                @empty($enseigne->logo)
                                    ...
                                    @else
                                    <a href="#" class="avatar rounded-circle mr-3">
                                        <img alt="{{$enseigne->nom}}" src="{{asset('web/images/marques').'/'.$enseigne->logo}}">
                                    </a>
                                    @endempty
                            </div>
                        </div>
