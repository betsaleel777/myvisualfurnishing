      ...
      <div class="card">
         <div class="card-body">
            <form method="post" action="{{ route('produit_store') }}" enctype="multipart/form-data">
               <!-- Address -->
               <h6 class="heading-small text-muted mb-4">Ajouter un produit</h6>
               <div class="pl-lg-4">
                  @csrf
                  <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('nom') }}" id="input-address" name="nom" class="form-control @error('nom') is-invalid @enderror"
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('prix') }}" id="prix" name="prix" class="form-control @error('prix') is-invalid @enderror"
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <input value="{{ old('prix_solde') }}" id="prix_solde" name="prix_solde"
               ...
               <div class="col-md-12">
                  <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input name="livrable" type="checkbox" class="custom-control-input" id="livrable">
                        <label class="custom-control-label" for="livrable">Livrable</label>
                    </div>
                  </div>
                  @error('livrable') <div class="text-danger">{{ $message }}</div>@enderror
               </div>
               <div class="col-md-12">
                  <div class="form-group">
                     <div class="custom-file">
                        ...
                        <input name="main_image" type="file" class="custom-file-input @error('main_image') is-invalid @enderror"
                           value="{{ old('main_image') }}" id="customFileLang" lang="fr">
                        @error('main_image')
                           <div class="text-danger">{{ $message }}</div>
                        @enderror
                     </div>
               ...
               <div class="col-md-12">
                  <div class="form-group">
                     <div class="custom-file">
                        ...
                        <input name="shodai" type="file" class="custom-file-input @error('shodai') is-invalid @enderror" value="{{ old('shodai') }}"
                           id="shodai" lang="fr">
                        @error('shodai')
                           <div class="text-danger">{{ $message }}</div>
                        @enderror
               ...
               <div class="col-md-12">
                  <div class="form-group">
                        ...
                        <textarea {{ old('description') }} name="description" class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
                      @error('description')
                           <div class="text-danger">{{ $message }}</div>
                      @enderror
                  </div>
