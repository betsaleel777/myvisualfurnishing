            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Catégaries</h6>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input value="{{$categorie->nom}}" id="input-address" name="nom" class="form-control @error('nom') is-invalid @enderror" placeholder="nom de la marque" type="text">
                                    @error('nom')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="#" class="avatar avatar-lg rounded-circle" data-toggle="tooltip" data-original-title="{{$categorie->nom}}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="custom-file">
                                        ...
                                        <input name="logo" type="file" class="custom-file-input @error('image') is-invalid @enderror" id="customFileLang" lang="fr">
                                        @error('image')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
